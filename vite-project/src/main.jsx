...
const router = createBrowserRouter([
  {
    ...
    <artilcle className ="Why">
      <div>
        ...
        <l1>Java</l1>
        <l1>C++</l1>
        <p>Learning C++ can help you land more oppertunites at work.</p>
    ...
    <p><ps>PS: Don't look at the code for this website. For some reason things would not work at all and I didn't have the time to right my wrongs. I wanted to do a cool side bar on the side for the topics but for some reason it works on the wrong repo and not this one. I think my Node.JS is corrupted or the React stuff didn't copy over right? Anyways this code is the only way this website works so please don't question it. :D</ps></p>
